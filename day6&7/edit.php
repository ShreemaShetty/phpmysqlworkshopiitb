...
$current_id=$_GET['_id'];
$mail=$_SESSION['mail'];     
$select = "Select * FROM marks,student where marks.student_id='$current_id' AND student.id='$current_id'"; 
...
<body>
    <h1 style="text-align: center;">Update Form</h1>
        ...
        <br>
        Subject 1 <input type="text" name="Sub1" value="<?php echo $subject1 ?>" required>
        <br>
        Subject 2 <input type="text" name="Sub2" value="<?php echo $subject2 ?>" required>
        <br>
        Subject 3 <input type="text" name="Sub3" value="<?php echo $subject3 ?>" required>
        <br>
